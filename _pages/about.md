...
Beyond research, I actively contribute to open-source projects, explore cutting-edge AI techniques, and seek to bridge the gap between **computational models and real-world fire safety applications**. I aim to push the boundaries of deep learning in fire dynamics and safety engineering, ensuring AI-driven solutions can assist in real-time disaster prevention and mitigation.  

## 🚀 Motto  
*"Science and technology light the way forward."*  
